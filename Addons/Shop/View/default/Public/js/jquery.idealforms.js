(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
            ...
            methods: {
                ...
                _init: function () {
                    ...
                    function adapt() {
                        ...
                        var formWidth = self.$form.outerWidth(), isAdaptive = self.opts.adaptiveWidth > formWidth;
                ...
                _init: function () {
                    ...
                    $.extend($.idealforms.rules, {
                        ...
                        ajax: function (input) {
                            ...
                            var self = this, $field = this._getField(input), url = $(input).data('idealforms-ajax'), userError = $.idealforms._getKey('errors.' + input.name + '.ajaxError', self.opts), requests = $.idealforms._requests, data = {};
        ...
        (function ($, win, doc, undefined) {
            ...
            var multipleSupport = typeof $('<input/>')[0].multiple !== 'undefined', isIE = /msie/i.test(navigator.userAgent), plugin = {};
            ...
            plugin.methods = {
                ...
                _init: function () {
                    ...
                    var $file = $(this.el).addClass('ideal-file') // the original file input
                        , $wrap = $('<div class="ideal-file-wrap">'), $input = $('<input type="text" class="ideal-file-filename" />')
                        ...
                        $datepicker.each(function () {
                            ...
                            $(this).datepicker({
                                ...
                                onChangeMonthYear: function () {
                                    ...
                                    var $this = $(this), width = $this.outerWidth(); // cache first!
                                    setTimeout(function () {
        ...
        function template(html, data) {
            ...
            var loop = /\{@([^}]+)\}(.+?)\{\/\1\}/g, loopVariable = /\{#([^}]+)\}/g, variable = /\{([^}]+)\}/g;
      ...
      '
            ...
            methods: {
                ...
                addFields: function (fields) {
                    ...
                    $.each(fields, function (name, field) {
                        ...
                        var typeArray = field.type.split(':'), rules = {}, $last = self.$form.find(self.opts.field).last();
        ...
        module.exports = {
            ...
            methods: {
                ...
                _buildSteps: function () {
                    ...
                    var self = this, options, hasRules = !$.isEmptyObject(this.opts.rules), buildNavItems = this.opts.steps.buildNavItems, counter = hasRules
                        ? '<span class="counter"/>'
        ...
        module.exports = (function () {
            ...
            return function (plugin) {
                ...
                $.fn[plugin.name] = function () {
                    ...
                    var args = AP.slice.call(arguments), methodArray = typeof args[0] == 'string' && args[0].split(':'), method = methodArray[methodArray.length > 1 ? 1 : 0], prefix = methodArray.length > 1 && methodArray[0], opts = typeof args[0] == 'object' && args[0], params = args.slice(1), ret;
        ...
        module.exports = {
            ...
            _i18n: function () {
                ...
                $.each($.idealforms.i18n, function (locale, lang) {
                    ...
                    var errors = lang.errors, options = {};
            ...
            _buildField: function (input) {
                ...
                var self = this, $field = this._getField(input), $icon;
            ...
            _addEvents: function (input) {
                ...
                var self = this, $field = this._getField(input);
            ...
            _validate: function (input, handleError, handleStyle) {
                ...
                var self = this, $field = this._getField(input), userRules = this.opts.rules[input.name].split($.idealforms.ruleSeparator), oldValue = $field.data('idealforms-value'), valid = true, rule;
                ...
                if (!input.value && !this._isRequired(input)) {
                    ...
                    $.each(userRules, function (i, userRule) {
                        ...
                        var theRule = $.idealforms.rules[rule], args = userRule.slice(1), error;
            ...
            _validateAll: function (handleError, handleStyle) {
                ...
                this.$inputs.each(function () {
                    self._validate(this, handleError, handleStyle);
                });
            }
        };
        ...
        module.exports = {
            ...
            reset: function (name) {
                ...
                var self = this, $inputs = this.$inputs;
        ...
        module.exports = {
            ...
            equalto: function (input, value, target) {
                ...
                var self = this, $target = $('[name="' + target + '"]');
