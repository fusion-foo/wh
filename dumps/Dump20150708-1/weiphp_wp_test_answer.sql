...
--
-- Table structure for table `wp_test_answer`
--
...
--
-- Dumping data for table `wp_test_answer`
--

LOCK TABLES `wp_test_answer` WRITE;
/*!40000 ALTER TABLE `wp_test_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_test_answer` ENABLE KEYS */;
UNLOCK TABLES;
