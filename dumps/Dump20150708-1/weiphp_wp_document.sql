...
--
-- Table structure for table `wp_document`
--
...
--
-- Dumping data for table `wp_document`
--

LOCK TABLES `wp_document` WRITE;
/*!40000 ALTER TABLE `wp_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_document` ENABLE KEYS */;
UNLOCK TABLES;
