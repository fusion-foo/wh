...
--
-- Table structure for table `wp_addon_category`
--
...
--
-- Dumping data for table `wp_addon_category`
--

LOCK TABLES `wp_addon_category` WRITE;
/*!40000 ALTER TABLE `wp_addon_category` DISABLE KEYS */;
INSERT INTO `wp_addon_category` VALUES (1,74,'教育行业',2),(2,74,'基础插件',0),(3,74,'互动类',1),(4,74,'高级插件',3);
/*!40000 ALTER TABLE `wp_addon_category` ENABLE KEYS */;
UNLOCK TABLES;
