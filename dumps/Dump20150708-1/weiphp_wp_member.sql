...
--
-- Dumping data for table `wp_member`
--

LOCK TABLES `wp_member` WRITE;
/*!40000 ALTER TABLE `wp_member` DISABLE KEYS */;
INSERT INTO `wp_member` VALUES (1,'fusion',0,'0000-00-00','',0,59,0,1430755370,0,1436253825,1,NULL,NULL),(364,'soing',0,'0000-00-00','',0,5,2130706433,1432030819,1899695285,1432138395,1,NULL,NULL);
/*!40000 ALTER TABLE `wp_member` ENABLE KEYS */;
UNLOCK TABLES;
