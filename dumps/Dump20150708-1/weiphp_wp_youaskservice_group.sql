...
--
-- Table structure for table `wp_youaskservice_group`
--
...
--
-- Dumping data for table `wp_youaskservice_group`
--

LOCK TABLES `wp_youaskservice_group` WRITE;
/*!40000 ALTER TABLE `wp_youaskservice_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_youaskservice_group` ENABLE KEYS */;
UNLOCK TABLES;
