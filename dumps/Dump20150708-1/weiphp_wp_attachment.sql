...
--
-- Table structure for table `wp_attachment`
--
...
--
-- Dumping data for table `wp_attachment`
--

LOCK TABLES `wp_attachment` WRITE;
/*!40000 ALTER TABLE `wp_attachment` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_attachment` ENABLE KEYS */;
UNLOCK TABLES;
