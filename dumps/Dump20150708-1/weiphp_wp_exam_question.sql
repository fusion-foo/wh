...
--
-- Table structure for table `wp_exam_question`
--
...
--
-- Dumping data for table `wp_exam_question`
--

LOCK TABLES `wp_exam_question` WRITE;
/*!40000 ALTER TABLE `wp_exam_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_exam_question` ENABLE KEYS */;
UNLOCK TABLES;
