...
--
-- Table structure for table `wp_custom_reply_mult`
--
...
--
-- Dumping data for table `wp_custom_reply_mult`
--

LOCK TABLES `wp_custom_reply_mult` WRITE;
/*!40000 ALTER TABLE `wp_custom_reply_mult` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_custom_reply_mult` ENABLE KEYS */;
UNLOCK TABLES;
