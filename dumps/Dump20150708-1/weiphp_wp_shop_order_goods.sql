...
--
-- Table structure for table `wp_shop_order_goods`
--
...
--
-- Dumping data for table `wp_shop_order_goods`
--

LOCK TABLES `wp_shop_order_goods` WRITE;
/*!40000 ALTER TABLE `wp_shop_order_goods` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_shop_order_goods` ENABLE KEYS */;
UNLOCK TABLES;
