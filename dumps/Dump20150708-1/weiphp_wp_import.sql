...
--
-- Table structure for table `wp_import`
--
...
--
-- Dumping data for table `wp_import`
--

LOCK TABLES `wp_import` WRITE;
/*!40000 ALTER TABLE `wp_import` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_import` ENABLE KEYS */;
UNLOCK TABLES;
