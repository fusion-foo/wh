...
--
-- Table structure for table `wp_survey`
--
...
--
-- Dumping data for table `wp_survey`
--

LOCK TABLES `wp_survey` WRITE;
/*!40000 ALTER TABLE `wp_survey` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_survey` ENABLE KEYS */;
UNLOCK TABLES;
