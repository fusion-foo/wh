...
--
-- Table structure for table `wp_channel`
--
...
--
-- Dumping data for table `wp_channel`
--

LOCK TABLES `wp_channel` WRITE;
/*!40000 ALTER TABLE `wp_channel` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_channel` ENABLE KEYS */;
UNLOCK TABLES;
