...
--
-- Table structure for table `wp_suggestions`
--
...
--
-- Dumping data for table `wp_suggestions`
--

LOCK TABLES `wp_suggestions` WRITE;
/*!40000 ALTER TABLE `wp_suggestions` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_suggestions` ENABLE KEYS */;
UNLOCK TABLES;
