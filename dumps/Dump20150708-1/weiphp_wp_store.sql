...
--
-- Table structure for table `wp_store`
--
...
--
-- Dumping data for table `wp_store`
--

LOCK TABLES `wp_store` WRITE;
/*!40000 ALTER TABLE `wp_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_store` ENABLE KEYS */;
UNLOCK TABLES;
