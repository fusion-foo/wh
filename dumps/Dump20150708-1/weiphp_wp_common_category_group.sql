...
--
-- Table structure for table `wp_common_category_group`
--
...
--
-- Dumping data for table `wp_common_category_group`
--

LOCK TABLES `wp_common_category_group` WRITE;
/*!40000 ALTER TABLE `wp_common_category_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_common_category_group` ENABLE KEYS */;
UNLOCK TABLES;
