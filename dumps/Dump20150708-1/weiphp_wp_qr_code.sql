...
--
-- Table structure for table `wp_qr_code`
--
...
--
-- Dumping data for table `wp_qr_code`
--

LOCK TABLES `wp_qr_code` WRITE;
/*!40000 ALTER TABLE `wp_qr_code` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_qr_code` ENABLE KEYS */;
UNLOCK TABLES;
