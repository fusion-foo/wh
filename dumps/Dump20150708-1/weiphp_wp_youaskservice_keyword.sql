...
--
-- Table structure for table `wp_youaskservice_keyword`
--
...
--
-- Dumping data for table `wp_youaskservice_keyword`
--

LOCK TABLES `wp_youaskservice_keyword` WRITE;
/*!40000 ALTER TABLE `wp_youaskservice_keyword` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_youaskservice_keyword` ENABLE KEYS */;
UNLOCK TABLES;
