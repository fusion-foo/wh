...
--
-- Table structure for table `wp_update_version`
--
...
--
-- Dumping data for table `wp_update_version`
--

LOCK TABLES `wp_update_version` WRITE;
/*!40000 ALTER TABLE `wp_update_version` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_update_version` ENABLE KEYS */;
UNLOCK TABLES;
