...
--
-- Table structure for table `wp_survey_question`
--
...
--
-- Dumping data for table `wp_survey_question`
--

LOCK TABLES `wp_survey_question` WRITE;
/*!40000 ALTER TABLE `wp_survey_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_survey_question` ENABLE KEYS */;
UNLOCK TABLES;
