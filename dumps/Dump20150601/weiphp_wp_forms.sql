...
--
-- Table structure for table `wp_forms`
--
...
--
-- Dumping data for table `wp_forms`
--

LOCK TABLES `wp_forms` WRITE;
/*!40000 ALTER TABLE `wp_forms` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_forms` ENABLE KEYS */;
UNLOCK TABLES;
