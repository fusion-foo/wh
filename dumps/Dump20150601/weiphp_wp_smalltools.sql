...
--
-- Table structure for table `wp_smalltools`
--
...
--
-- Dumping data for table `wp_smalltools`
--

LOCK TABLES `wp_smalltools` WRITE;
/*!40000 ALTER TABLE `wp_smalltools` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_smalltools` ENABLE KEYS */;
UNLOCK TABLES;
