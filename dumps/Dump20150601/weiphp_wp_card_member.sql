...
--
-- Table structure for table `wp_card_member`
--
...
--
-- Dumping data for table `wp_card_member`
--

LOCK TABLES `wp_card_member` WRITE;
/*!40000 ALTER TABLE `wp_card_member` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_card_member` ENABLE KEYS */;
UNLOCK TABLES;
