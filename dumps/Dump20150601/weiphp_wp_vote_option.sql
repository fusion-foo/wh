...
--
-- Table structure for table `wp_vote_option`
--
...
--
-- Dumping data for table `wp_vote_option`
--

LOCK TABLES `wp_vote_option` WRITE;
/*!40000 ALTER TABLE `wp_vote_option` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_vote_option` ENABLE KEYS */;
UNLOCK TABLES;
