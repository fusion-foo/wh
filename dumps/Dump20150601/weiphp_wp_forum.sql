...
--
-- Table structure for table `wp_forum`
--
...
--
-- Dumping data for table `wp_forum`
--

LOCK TABLES `wp_forum` WRITE;
/*!40000 ALTER TABLE `wp_forum` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_forum` ENABLE KEYS */;
UNLOCK TABLES;
