...
--
-- Table structure for table `wp_weisite_cms`
--
...
--
-- Dumping data for table `wp_weisite_cms`
--

LOCK TABLES `wp_weisite_cms` WRITE;
/*!40000 ALTER TABLE `wp_weisite_cms` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_weisite_cms` ENABLE KEYS */;
UNLOCK TABLES;
