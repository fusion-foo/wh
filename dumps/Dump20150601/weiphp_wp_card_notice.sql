...
--
-- Table structure for table `wp_card_notice`
--
...
--
-- Dumping data for table `wp_card_notice`
--

LOCK TABLES `wp_card_notice` WRITE;
/*!40000 ALTER TABLE `wp_card_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_card_notice` ENABLE KEYS */;
UNLOCK TABLES;
