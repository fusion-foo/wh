...
--
-- Table structure for table `wp_test_question`
--
...
--
-- Dumping data for table `wp_test_question`
--

LOCK TABLES `wp_test_question` WRITE;
/*!40000 ALTER TABLE `wp_test_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_test_question` ENABLE KEYS */;
UNLOCK TABLES;
