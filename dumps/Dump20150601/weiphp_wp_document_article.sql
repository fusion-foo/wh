...
--
-- Table structure for table `wp_document_article`
--
...
--
-- Dumping data for table `wp_document_article`
--

LOCK TABLES `wp_document_article` WRITE;
/*!40000 ALTER TABLE `wp_document_article` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `wp_document_article` ENABLE KEYS */;
UNLOCK TABLES;
