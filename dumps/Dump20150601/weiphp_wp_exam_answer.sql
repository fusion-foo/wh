...
--
-- Table structure for table `wp_exam_answer`
--
...
--
-- Dumping data for table `wp_exam_answer`
--

LOCK TABLES `wp_exam_answer` WRITE;
/*!40000 ALTER TABLE `wp_exam_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_exam_answer` ENABLE KEYS */;
UNLOCK TABLES;
