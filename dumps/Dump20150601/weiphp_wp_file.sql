...
--
-- Table structure for table `wp_file`
--
...
--
-- Dumping data for table `wp_file`
--

LOCK TABLES `wp_file` WRITE;
/*!40000 ALTER TABLE `wp_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_file` ENABLE KEYS */;
UNLOCK TABLES;
