...
--
-- Table structure for table `wp_forms_value`
--
...
--
-- Dumping data for table `wp_forms_value`
--

LOCK TABLES `wp_forms_value` WRITE;
/*!40000 ALTER TABLE `wp_forms_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_forms_value` ENABLE KEYS */;
UNLOCK TABLES;
