...
--
-- Table structure for table `wp_ucenter_app`
--
...
--
-- Dumping data for table `wp_ucenter_app`
--

LOCK TABLES `wp_ucenter_app` WRITE;
/*!40000 ALTER TABLE `wp_ucenter_app` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_ucenter_app` ENABLE KEYS */;
UNLOCK TABLES;
