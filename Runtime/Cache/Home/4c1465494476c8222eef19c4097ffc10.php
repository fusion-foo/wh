...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
            <?php if($need_datainfo): $__FOR_START_2093226298__=0;$__FOR_END_2093226298__=$ayitem;for($i=$__FOR_START_2093226298__;$i < $__FOR_END_2093226298__;$i+=1){ ?><div class="index_tap total">
